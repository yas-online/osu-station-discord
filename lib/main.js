...
"	\"owner\":\n" +
"	{\n" +
"		// If you know your internal user id, uncomment and enter here\n" +
"		//\"id\": -1\n" +
"\n" +
"		// Since usernames aren't unique, provide username + discriminator (snowflake id)\n" +
