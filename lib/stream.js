...
*/
	...
	Disconnect()
	{
		...
		{
/*
			// ToDo: wait for a stream reset(), or just recreate the instance...
			if( this.m_hDecoder.readable )
			{
				this.m_hDecoder._readableState.buffer.clear();
				this.m_hDecoder._readableState.length = 0;
			}
			if( this.m_hDecoder.writable )
			{
				this.m_hDecoder._writableState.length = 0;
			}
*/
...
/*
			// ToDo: wait for a stream reset(), or just recreate the instance...
			if( this.m_hEncoder.readable )
			{
				this.m_hEncoder._readableState.buffer.clear();
				this.m_hEncoder._readableState.length = 0;
			}
			if( this.m_hEncoder.writable )
			{
				this.m_hEncoder._writableState.length = 0;
			}
*/
